...
Admin CRUD: Logo · Banners · Services · Projects · Expertise · Industries · Technology · Partners · Careers · Blogs · Blog Categories
...
3. From the sidebar you can create/update/delete:
   ...
   - **Settings** — site-wide configuration (how many services and blog posts show on the homepage)
