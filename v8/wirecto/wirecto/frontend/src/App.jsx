...
import ParentMenuPage from "./pages/ParentMenuPage.jsx";
import SubmenuDetail from "./pages/SubmenuDetail.jsx";
...
import ParentMenus from "./pages/admin/ParentMenus.jsx";
import SubmenuItems from "./pages/admin/SubmenuItems.jsx";
  ...
  return (
    <Routes>
      ...
      <Route element={<PublicLayout />}>
        ...
        <Route path="/legal/:slug" element={<PolicyDetail />} />

        {/* Dynamic Navigation Menu module: catch-all routes for admin-managed parent menus
            and their submenu items, e.g. /expertise, /expertise/cloud-erp, /technology/react-js.
            React Router ranks static paths above dynamic ones, so this never shadows the
            explicit routes above (e.g. /services/:slug still wins over /:parentSlug/:submenuSlug). */}
        <Route path="/:parentSlug" element={<ParentMenuPage />} />
        <Route path="/:parentSlug/:submenuSlug" element={<SubmenuDetail />} />
      </Route>
      ...
      >
        ...
        <Route path="parent-menus" element={<ParentMenus />} />
        <Route path="submenu-items" element={<SubmenuItems />} />
